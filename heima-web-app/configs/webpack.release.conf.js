...
console.log(`${chalk.green(`Package web project at ${chalk.bold(path.resolve('./releases/web'))}!`)}`)
/**
 * Webpack Plugins
 */
...
const productionConfig = webpackMerge(commonConfig[0], {
  ...
  output: {
     ...
     */
    path: helper.rootNode('releases/web'),
    /**
  ...
  plugins: [
     ...
     * This is especially useful for webpack bundles that include utils hash in the filename
